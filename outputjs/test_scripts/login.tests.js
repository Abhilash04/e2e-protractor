...
describe("Login MyStake Application", function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, loginPage.launchApplication()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    it(testdata.tc_001.name, function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loginPage.loginToApp(testdata.tc_001.username, testdata.tc_001.password)];
                    case 1:
                        homePage = _a.sent();
                        return [4 /*yield*/, homePage.verifyLoginSuccessful()];
                    case 2:
                        result = _a.sent();
                        if (result) {
    ...
    it(testdata.tc_002.name, function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, loginPage.loginToApp(testdata.tc_002.username, testdata.tc_002.password)];
                    case 1:
                        homePage = _a.sent();
                        return [4 /*yield*/, homePage.loginErrorValidation()];
                    case 2:
                        result = _a.sent();
                        if (result) {
...
//# sourceMappingURL=login.tests.js.map